// Assets/Scripts/Examples/TossStorageRemoveItemAsyncExample.cs
...
public class TossStorageRemoveItemAsyncExample : MonoBehaviour
{
    ...
    async void Start()
    {
        ...
        // Storage에서 값 삭제 (Async)
        try
        {
            string result = await tossStorageJsBridge.RemoveItemAsync("my-key");
            debug_Text.text = $"삭제 성공: {result}";
            // 아무문제도 없으면 성공!!
        }

// Assets/Scripts/Examples/TossStorageAllClearItemAsyncExample.cs
...
public class TossStorageAllClearItemAsyncExample : MonoBehaviour
{
    ...
    async void Start()
    {
        ...
        // Storage 전체 초기화 (Async)
        try
        {
            string result = await tossStorageJsBridge.AllClearItemAsync();
            debug_Text.text = $"초기화 성공: {result}";
            // 아무문제도 없으면 성공!!
        }

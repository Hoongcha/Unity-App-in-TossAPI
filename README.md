...
- [백그라운드,포그라운드 감지](https://github.com/Hoongcha/Unity-App-in-TossAPI/wiki/백그라운드-,-foreground-감지)<br>**[* 참고한 issue](https://techchat-apps-in-toss.toss.im/t/webgl-off-3/474/2)**&nbsp;&nbsp;`사운드 끄고 켜기 예제 포함`
